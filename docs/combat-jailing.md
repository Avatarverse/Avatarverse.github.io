...
Being knocked out also prevents you from using certain commands:

- ``/message``, ``/tell``, etc.
- ``/bird``
- ``/tpa``, ``/tpahere``, ``/tpaccept``, etc.
- ``/home``
- ``/dynmap``
- ``/hat``
...
Additionally, all of the commands blocked during knock-out are also blocked when handcuffed or shackled.
